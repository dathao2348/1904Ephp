...
<body>
    <pre>
        ...
        Link các múi giờ châu á: https://www.php.net/manual/en/timezones.asia.php
        Link các múi giờ thế giới: https://www.php.net/manual/en/timezones.php

        Nếu muốn lấy giờ hiện tại chính xác thì cần đặt đúng giờ zone đó
